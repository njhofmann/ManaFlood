...
/**
 * Tests for ensuring that created {@link DeckInstance} and {@link InformativeDeckInstance}
...
public class DeckInstanceCreationTest {
  ...
  @DisplayName("Deck instance tests")
  @Nested
  class DeckInstanceTests {
  ...
  @DisplayName("Informative deck instance tests")
  @Nested
  class InformativeDeckInstanceTests {
