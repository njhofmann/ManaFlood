...
public class CardPrintingEqualityTest {
  ...
  @DisplayName("Card printing tests")
  @Nested
  class CardPrintingTests {
  ...
  @DisplayName("Informative card printing tests")
  @Nested
  class InformativeCardPrintingTests {

  }

  @DisplayName("Comparison tests between card printings and informative card printings")
  @Nested
